/*
 ...
 @version 0.9.2
*/
const [DISPLAY,STANDARD,LOGO]=[Symbol.for("display"),Symbol.for("standard"),Symbol.for("logo")],[BUTT,SQUARE,ROUND]=[Symbol.for("butt"),Symbol.for("square"),Symbol.for("round")],[STYLE,POS,STYLE_POS]=[1,2,3],[LT,CT,RT,JT]=[-1,0,1,2],[TG]=function(){const {PI:e,abs:n,atan2:h,ceil:k,cos:p,max:q,sign:l,sin:y,sqrt:g}=Math,[u,r]=[Math.PI/2,2*Math.PI],x=(a,b=r)=>{for(;0>a;)a+=b;for(;a>=b;)a-=b;return a},H=(a,b)=>{let d=(a-b)**2/(a+b)**2;return e*(a+b)*(1+3*d/(10+g(4-3*d)))},I=(a,b,d,f,m,v)=>{d*=p(v);f*=
y(v);v=Math.sin(m);m=Math.cos(m);return[a+d*m-f*v,b+f*m+d*v]},[Q,R,C]=[1,-1,0],[D,K]=[0,1],[L,M]=[1,-1],S=5*e,E=new Map;class A{static clearRecords(){E.clear()}static setRecord(a,b){E.set(a,b)}static hasRecord(a){return E.has(a)}static getRecord(a){if(A.hasRecord(a))return E.get(a).map(b=>b.clone())}static getTurtle(a,b,d){return new A(a,b,d)}constructor(a,b,d=DISPLAY,f=!0){this._b=new OffscreenCanvas(a,b);this._bdc=this._b.getContext("2d");this._interval=25;this._polygons=new Map;this._snapshots=
new Map;this._set_mode(d);this._degrees=f;this._earlier=this._timer=0;this._font="400 normal 14px sans-serif";this.setTurtle(DART);this._reset()}draw(a,b=0,d=0){let f=this._b.width,m=this._b.height,v=f/2,z=m/2;a.save();a.translate(b,d);a.beginPath();a.moveTo(-v,-z);a.lineTo(v,-z);a.lineTo(v,z);a.lineTo(-v,z);a.closePath();a.clip();switch(this._mode){case LOGO:a.rotate(-u);break;case STANDARD:a.scale(1,-1)}a.drawImage(this._b,0,0,f,m,-v,-z,f,m);this._penDown&&this._taskQueue[0]&&this._taskQueue[0].render&&
this._taskQueue[0].render(a);this._csrVisible&&(a.translate(this._penX,this._penY),a.rotate(isNaN(this._tilt)?this._penA:this._tilt),a.drawImage(this._cursor.icon,-this._cursor.hitX,-this._cursor.hitY));a.restore()}_getCopy(){let a=turtle._b,b=a.width,d=a.height,f=b/2,m=d/2,v=new OffscreenCanvas(a.width,a.height),z=v.getContext("2d");z.translate(a.width/2,a.height/2);switch(turtle._mode){case LOGO:z.rotate(-u);break;case STANDARD:z.scale(1,-1)}z.drawImage(a,0,0,b,d,-f,-m,b,d);return v}x(a,b=!1){return this._addTask(new F(D,
...
return 0===m?this._addTask(new W(a,b,d,f)):this._addTask(new X(a,b,d,f,k(m)))}sleep(a){return this._addTask(new Y(a))}write(a,b="left",d=!1,f){return this._addTask(new Z(a,b,d,f))}font(a){return this._addTask(new w("_font",a))}up(){return this._addTask(new w("_penDown",!1))}pu(){return this.up()}penup(){return this.up()}down(){return this._addTask(new w("_penDown",!0))}pd(){return this.down()}pendown(){return this.down()}pensize(a=2){return this._addTask(new w("_penSize",a))}dash(a=[]){this._addTask(new w("_penDash",
a));return this}pendash(a=[]){return this.dash(a)}cap(a){return this._addTask(new w("_penCap",a))}pencap(a){return this.cap(a)}pencolor(a){return this._addTask(new w("_penColor",a))}fillcolor(a){return this._addTask(new w("_fillColor",a))}push_pen(){return this._addTask(new N(L))}pop_pen(a=STYLE_POS){return this._addTask(new N(M,a))}turtle(a){return"Cursor"===a?.constructor?.name?this._addTask(new w("_cursor",a)):this}st(){return this._addTask(new w("_csrVisible",!0))}showturtle(){return this.st()}ht(){return this._addTask(new w("_csrVisible",
!1))}hideturtle(){return this.ht()}tilt(a){return this._addTask(new w("_tilt",this._fix(a)))}speed(a,b){isFinite(a)&&0<a&&this._addTask(new w("_lnrSpeed",a));isFinite(b)&&0<b&&this._addTask(new w("_angSpeed",this._degrees?b*e/180:b));return this}begin_fill(){return this._addTask(new O)}end_fill(a=!1){return this._addTask(new P(a))}begin_poly(){return this._addTask(new aa)}end_poly(a){return this._addTask(new ba(a))}begin_record(){return this._addTask(new ca)}end_record(a){return this._addTask(new da(a))}do(a,
...
(this._degrees?-90:-u))};this._mode=a;break;case STANDARD:this._p_m_XY=function(b,d){return[b,d]};this._s_m_XY=function(b,d,f=0,m=0){return[b-f,m-d]};this._m_s_XY=function(b,d,f=0,m=0){return[b+f,-d+m]};this._s_m_Angle=this._m_s_Angle=function(b){return this._norm(-b+(this._degrees?360:r))};this._mode=a;break;default:this._p_m_XY=function(b,d){return[b,d]},this._s_m_XY=function(b,d,f=0,m=0){return[b-f,d-m]},this._m_s_XY=function(b,d,f=0,m=0){return[b+f,d+m]},this._s_m_Angle=this._m_s_Angle=function(b){return this._norm(b)},
...
return d}}class G extends t{constructor(...a){super(...a);this._length=a[0];this._dir=a[1];this.setWAITING()}init(a){this.recordManager(a);[this._fillStyle,this._strokeStyle,this._penSize,this._penDown]=[a._fillColor,a._penColor,a._penSize,a._penDown];this._lineCap=Symbol.keyFor(a._penCap);this._lineDash=[...a._penDash];[this._sx,this._sy,this._ang]=[a._penX,a._penY,a._penA];this._ex=this._sx+this._dir*this._length*p(this._ang);this._ey=this._sy+this._dir*this._length*y(this._ang);this._tx=this._sx;
...
class V extends t{constructor(...a){super(...a);this._size=a[0];this._fcol=a[1];this._sw=a[2];this._scol=a[3]}perform(a,b){this.recordManager(a);[this._sx,this._sy,this._penDown]=[a._penX,a._penY,a._penDown];this._angle=a._penA;this._fcol="current"==this._fcol?a._fillColor:this._fcol;this._scol="current"==this._scol?a._penColor:this._scol;this._sw=0<this._sw?Number(this._sw):0==this._sw?a._penSize:0;this._xp=-this._size*p(e/6);this._yp=this._size*y(e/6)}render(a,b=0,d=0){!this.isWAITING()&&this._penDown&&
