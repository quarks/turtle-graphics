...
a.lineWidth=this._sw),a.beginPath(),a.moveTo(0,0),a.lineTo(this._xp,this._yp),a.lineTo(this._xp,-this._yp),a.lineTo(0,0),a.fill(),0<this._sw&&a.stroke(),a.closePath(),a.restore())}}class ba extends t{constructor(...a){super(...a);this._text=a[0];this._move=a[1];this._align=a[2];this._font=a[3];this.setWAITING()}init(a){this.recordManager(a);[this._sx,this._sy,this._fillColor,this._mode,this._penDown]=[a._penX,a._penY,a._fillColor,a._mode,a._penDown];this._align="center"===this._align||"right"===this._align?
this._align:"left";this._font=this._font??a._font;this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);this._move&&"right"!==this._align&&(a._bdc.font=this._font,b=a._bdc.measureText(this._text).width,"center"===this._align&&(b/=2),b=this._mode===LOGO?new E(this._sy+b,this._sx):new E(this._sx+b,this._sy),a._injectTasks([b]));this.setDONE()}render(a,b=0,d=0){if(!this.isWAITING()&&this._penDown){a.save();a.translate(this._sx+b/2,this._sy+d/2);a.font=this._font;a.textAlign=this._align;a.textBaseline=
"bottom";a.fillStyle=this._fillColor;switch(this._mode){case LOGO:a.rotate(u);break;case STANDARD:a.scale(1,-1)}a.fillText(this._text,0,0);a.restore()}}}class O extends t{constructor(...a){super(...a);this._action=a[0];this._what=a[1]}perform(a,b){this.recordManager(a);let d;switch(this._action){case M:d={style:[a._penDown,a._penSize,[...a._penDash],a._penCap,a._penColor,a._fillColor,a._animate,a._csrVisible,a._tilt],position:[a._penX,a._penY,a._penA]};a._penStack.push(d);break;case N:0<a.nbrStyles&&
(d=a._penStack.pop(),STYLE==(this._what&STYLE)&&([a._penDown,a._penSize,a._penDash,a._penCap,a._penColor,a._fillColor,a._animate,a._csrVisible,a._tilt]=d.style),POS===(this._what&POS)&&([a._penX,a._penY,a._penA]=d.position))}return b}}class ea extends t{constructor(...a){super(...a)}perform(a,b){a._record=[];a._recording=!0;return b}}class fa extends t{constructor(...a){super(...a);this._id=String(a[0])}perform(a,b){0<this._id.length&&!A.hasRecord(this._id)&&A.setRecord(this._id,a._record);a._recording=
!1;a._record=[];return b}}class ia extends t{constructor(...a){super(...a);this._id=a[0]}perform(a,b){let d=A.getRecord(this._id);d&&a._injectTasks(d);return b}}class ca extends t{constructor(...a){super(...a)}perform(a,b){this.recordManager(a);a._poly_track=!0;a._poly_points=[];a._poly_points.push(a._m_s_XY(a._penX,a._penY));return b}}class da extends t{constructor(...a){super(...a);this._id=a[0]}perform(a,b){this.recordManager(a);"string"===typeof this._id&&0<this._id.length&&(a._polygons.set(this._id,
