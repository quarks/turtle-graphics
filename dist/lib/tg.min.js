/*
 ...
 @version 0.9.0
*/
const [DISPLAY,STANDARD,LOGO]=[Symbol.for("display"),Symbol.for("standard"),Symbol.for("logo")],[BUTT,SQUARE,ROUND]=[Symbol.for("butt"),Symbol.for("square"),Symbol.for("round")],[LT,RT]=[-1,1],[TG]=function(){const [e,n,l,h,q,p,k,y]=[Math.abs,Math.atan2,Math.ceil,Math.cos,Math.max,Math.sign,Math.sin,Math.sqrt],[f,u,r]=[Math.PI,Math.PI/2,2*Math.PI],x=(a,b=r)=>{for(;0>a;)a+=b;for(;a>=b;)a-=b;return a},J=(a,b)=>{let d=(a-b)**2/(a+b)**2;return f*(a+b)*(1+3*d/(10+y(4-3*d)))},K=(a,b,d,g,m,w)=>{d*=h(w);
g*=k(w);w=Math.sin(m);m=Math.cos(m);return[a+d*m-g*w,b+g*m+d*w]},[S,T,C]=[1,-1,0],[D,L]=[0,1],[M,N]=[1,-1],U=3*f,F=new Map;class A{static clearRecords(){F.clear()}static setRecord(a,b){F.set(a,b)}static hasRecord(a){return F.has(a)}static getRecord(a){if(A.hasRecord(a))return F.get(a).map(b=>b.clone())}static getTurtle(a,b,d){return new A(a,b,d)}constructor(a,b,d=DISPLAY,g=!0){this._b=new OffscreenCanvas(a,b);this._bdc=this._b.getContext("2d");this._interval=25;this._polygons=new Map;this._snapshots=
new Map;this._set_mode(d);this._degrees=g;this._earlier=this._timer=0;this._font="400 normal 14px sans-serif";this.setTurtle(DART);this._reset()}draw(a,b=0,d=0){let g=this._b.width,m=this._b.height,w=g/2,z=m/2;a.save();a.translate(b,d);a.beginPath();a.moveTo(-w,-z);a.lineTo(w,-z);a.lineTo(w,z);a.lineTo(-w,z);a.closePath();a.clip();switch(this._mode){case LOGO:a.rotate(-u);break;case STANDARD:a.scale(1,-1)}a.drawImage(this._b,0,0,g,m,-w,-z,g,m);this._penDown&&this._taskQueue[0]&&this._taskQueue[0].render&&
this._taskQueue[0].render(a);this._csrVisible&&(a.translate(this._penX,this._penY),a.rotate(isNaN(this._tilt)?this._penA:this._tilt),a.drawImage(this._cursor.icon,-this._cursor.hitX,-this._cursor.hitY));a.restore()}x(a,b=!1){return this._addTask(new G(D,a,NaN,b))}y(a,b=!1){return this._addTask(new G(D,NaN,a,b))}xy(a,b,d=!1){return this._addTask(new G(D,a,b,d))}dxy(a,b,d=!1){return this._addTask(new G(L,a,b,d))}face(a){return this._addTask(new v("_penA",this._fix(a)))}fd(a){return this._addTask(new H(a,
S))}forward(a){return this.fd(a)}bk(a){return this._addTask(new H(a,T))}backward(a){return this.bk(a)}back(a){return this.bk(a)}lt(a){return this._addTask(new B(this._fix(a),LT))}left(a){return this.lt(a)}rt(a){return this._addTask(new B(this._fix(a),RT))}right(a){return this.rt(a)}head(a){return this._addTask(new B(this._fix(a),C))}heading(a){return this.head(a)}home(){return this._addTask(new V)}goto(a,b){return this._addTask(new E(D,a,b))}goby(a,b){return this._addTask(new E(L,a,b))}dot(a=6,b=
"current",d=.5,g="current"){return this._addTask(new W(a,b,d,g))}arrow(a=6,b="current",d=.5,g="current"){return this._addTask(new X(a,b,d,g))}circle(a,b=0,d=RT,g=0){return this.oval(a,a,b,d,g)}oval(a,b,d=0,g=RT,m=0){d=e(0===d?r:this._degrees?d*f/180:d);return 0===m?this._addTask(new Y(a,b,d,g)):this._addTask(new Z(a,b,d,g,l(m)))}sleep(a){return this._addTask(new aa(a))}write(a,b=!1,d="left",g){return this._addTask(new ba(a,b,d,g))}font(a){return this._addTask(new v("_font",a))}up(){return this._addTask(new v("_penDown",
!1))}pu(){return this.up()}penup(){return this.up()}down(){return this._addTask(new v("_penDown",!0))}pd(){return this.down()}pendown(){return this.down()}pensize(a=2){return this._addTask(new v("_penSize",a))}dash(a=[]){this._addTask(new v("_penDash",a));return this}pendash(a=[]){return this.dash(a)}cap(a){return this._addTask(new v("_penCap",a))}pencap(a){return this.cap(a)}pencolor(a){return this._addTask(new v("_penColor",a))}fillcolor(a){return this._addTask(new v("_fillColor",a))}push_style(){return this._addTask(new O(M))}pop_style(){return this._addTask(new O(N))}turtle(a){return"Cursor"===
a?.constructor?.name?this._addTask(new v("_cursor",a)):this}st(){return this._addTask(new v("_csrVisible",!0))}showturtle(){return this.st()}ht(){return this._addTask(new v("_csrVisible",!1))}hideturtle(){return this.ht()}tilt(a){return this._addTask(new v("_tilt",this._fix(a)))}speed(a,b){isFinite(a)&&0<a&&this._addTask(new v("_lnrSpeed",a));isFinite(b)&&0<b&&this._addTask(new v("_angSpeed",this._degrees?b*f/180:b));return this}begin_fill(){return this._addTask(new P)}end_fill(a=!1){return this._addTask(new Q(a))}begin_poly(){return this._addTask(new ca)}end_poly(a){return this._addTask(new da(a))}begin_record(){return this._addTask(new ea)}end_record(a){return this._addTask(new fa(a))}do(a,
...b){return"Function"===a.constructor.name?this._addTask(new ha(a,b)):"string"===typeof a?this._addTask(new ia(a)):this}animateon(){return this._addTask(new v("_animate",!0))}animateoff(){return this._addTask(new v("_animate",!1))}clear(){return this._addTask(new ja)}reset(){return this._addTask(new ka)}snapshot(a){return this._addTask(new la(a))}start(){this._startTurtle();this._autoStart=!0;return this}stop(){this._stopTurtle();this._autoStart=!1;return this}degrees(){this._degrees=!0}radians(){this._degrees=
...
Number.isNaN(b)||(this._angSpeed=this.degrees?b*f/180:b);return this}getSpeed(){return[this._lnrSpeed,this._degrees?180*this._angSpeed/f:this._angSpeed]}getPoly(a){return this._polygons.get(a)}getSnapshot(a){return this._snapshots.get(a)}setTurtle(a){a&&"string"===typeof a&&CURSORS.has(a)?this._cursor=CURSORS.get(a):"Cursor"===a?.constructor?.name&&(this._cursor=a);return this}setCursor(a){return this.setTurtle(a)}get hasTasks(){return 0<this.nbrTasks}get isActive(){return 0!=this._timer}get isAnimating(){return this._animate}get isVisible(){return this._csrVisible}get isPenDown(){return this._penDown}get isFilling(){return this._fill_track}get nbrTasks(){return this._taskQueue.length}get nbrStyles(){return this._styleStack.length}get mode(){return this._mode}get mode$(){return Symbol.keyFor(this._mode)}spawn(){let a=
new A(this._b.width,this._b.height,this._mode);for(let b of Object.keys(this))"object"!=typeof this[b]&&(a[b]=this[b]);a._penDash=[...this._penDash];a._cursor=this._cursor;a._poly_points=[];a._poly_track=!1;a._fill_points=[];a._fill_track=!1;a._timer=0;return a}_set_mode(a){switch(a){case LOGO:this._p_m_XY=function(b,d){return[d,b]};this._s_m_XY=function(b,d,g=0,m=0){return[b-g,m-d]};this._m_s_XY=function(b,d,g=0,m=0){return[g+d,m-b]};this._s_m_Angle=function(b){return this._norm(b+(this._degrees?
90:u))};this._m_s_Angle=function(b){return this._norm(b+(this._degrees?-90:-u))};this._mode=a;break;case STANDARD:this._p_m_XY=function(b,d){return[b,d]};this._s_m_XY=function(b,d,g=0,m=0){return[b-g,m-d]};this._m_s_XY=function(b,d,g=0,m=0){return[b+g,-d+m]};this._s_m_Angle=this._m_s_Angle=function(b){return this._norm(-b+(this._degrees?360:r))};this._mode=a;break;default:this._p_m_XY=function(b,d){return[b,d]},this._s_m_XY=function(b,d,g=0,m=0){return[b-g,d-m]},this._m_s_XY=function(b,d,g=0,m=0){return[b+
g,d+m]},this._s_m_Angle=this._m_s_Angle=function(b){return this._norm(b)},this._mode=DISPLAY}return this}_reset(){this._stopTurtle();this._taskQueue=[];this._styleStack=[];this._clear();this._autoStart=!1;this._lnrSpeed=160;this._angSpeed=U;this._fillColor="white";this._penColor="black";this._penSize=2;this._penA=this._penY=this._penX=0;this._penDown=!0;this._penDash=[];this._penCap=ROUND;this._animate=this._csrVisible=!0;this._fill_points=[];this._fill_track=!1;this._poly_points=[];this._poly_track=
!1;this._record=[];this._recording=!1;this._polygons.clear();this._snapshots.clear();this._tilt=NaN;return this}_update(){if(0==this.nbrTasks)return this._stopTurtle();var a=performance.now();let b=a-this._earlier;this._earlier=a;do a=this._taskQueue[0],b=a.perform(this,b),a.isDONE()&&(a.render&&a.render(this._bdc,this._b.width,this._b.height),this._taskQueue.shift());while(0<this.nbrTasks&&0<b)}_addTask(a){this._taskQueue.push(a);0===this._timer&&this._autoStart&&this._startTurtle();return this}_injectTasks(a,
b=1){this._taskQueue.splice(b,0,...a)}_clear(){this._bdc.clearRect(0,0,this._b.width,this._b.height);return this}_startTurtle(){0===this._timer&&(this._timer=setInterval(()=>this._update.call(this),this._interval),this._earlier=performance.now())}_stopTurtle(){clearInterval(this._timer);this._timer=0}_fix(a){for(this._degrees&&(a=a*f/180);0>a;)a+=r;for(;a>=r;)a-=r;return a}_norm(a){let b=this._degrees?360:r;for(;0>a;)a+=b;for(;a>=b;)a-=b;return a}}class t{constructor(...a){this._info=a;this.setDONE()}setWAITING(){this._status=
64}setREADY(){this._status=65}setDONE(){this._status=128}isWAITING(){return 64===this._status}isREADY(){return 65===this._status}isDONE(){return 128===this._status}clone(){return new this.constructor(...this._info)}recordManager(a){a._recording&&a._record.push(this.clone())}}class B extends t{constructor(...a){super(...a);this._ang=a[0];this._dir=a[1];this.setWAITING()}turnDir(a,b){a=x(a);b=x(b);let d;a=b-a;a>-f&&a<=f?d=a:a>f?d=a-r:a<=-f&&(d=a+r);return p(d)}init(a){this.recordManager(a);let b=this._dir;
var d=this._ang;this._angSpeed=a._angSpeed;a=x(a._penA);d=0===b?d:x(a+b*d);0===b&&(b=this.turnDir(a,d));switch(b){case LT:d>a&&(a+=r);break;case RT:a>d&&(d+=r)}this._sa=a;this._ea=d;this._range=d-a;this._dir=b;this._t=0;this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);let d=0;a._animate&&0!=this._range?(this._t+=e(this._dir*this._angSpeed*b/1E3/this._range),1<=this._t?(this.setDONE(),d=(this._t-1)*this._range*1E3/this._angSpeed,a._penA=x(this._ea)):(b=this._sa,a._penA=b+this._t*(this._ea-
b))):(this.setDONE(),d=b,a._penA=x(this._ea));return d}}class H extends t{constructor(...a){super(...a);this._length=a[0];this._dir=a[1];this.setWAITING()}init(a){this.recordManager(a);[this._fillStyle,this._strokeStyle,this._lineWidth,this._penDown]=[a._fillColor,a._penColor,a._penSize,a._penDown];this._lineCap=Symbol.keyFor(a._penCap);this._lineDash=[...a._penDash];[this._sx,this._sy,this._ang]=[a._penX,a._penY,a._penA];this._ex=this._sx+this._dir*this._length*h(this._ang);this._ey=this._sy+this._dir*
this._length*k(this._ang);this._tx=this._sx;this._ty=this._sy;this._t=0;this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);let d=0;a._animate?(this._t+=a._lnrSpeed*b*.001/this._length,1<=this._t?(this.setDONE(),d=(this._t-1)*this._length*1E3/a._lnrSpeed,this._tx=this._ex,this._ty=this._ey):(b=this._sx,this._tx=b+this._t*(this._ex-b),b=this._sy,this._ty=b+this._t*(this._ey-b))):(this._tx=this._ex,this._ty=this._ey,d=b,this.setDONE());a._penX=this._tx;a._penY=this._ty;this.isDONE()&&(a._fill_track&&
a._fill_points.push(["lineTo",a._penDown?"lineTo":"moveTo",a._penX,a._penY]),a._poly_track&&a._poly_points.push(a._m_s_XY(a._penX,a._penY)));return d}render(a,b=0,d=0){!this.isWAITING()&&this._penDown&&(a.save(),a.translate(b/2,d/2),a.fillStyle=this._fillStyle,a.strokeStyle=this._strokeStyle,a.lineWidth=this._lineWidth,a.lineCap=this._lineCap,a.setLineDash(this._lineDash),a.beginPath(),a.moveTo(this._sx,this._sy),a.lineTo(this._tx,this._ty),a.stroke(),a.restore())}}class Z extends t{constructor(...a){super(...a);
this._a=e(a[0]);this._b=e(a[1]);this._ext=a[2];this._turn=a[3];this._steps=a[4];this.setWAITING()}init(a){this._cx=a._penX-this._turn*this._b*k(a._penA);this._cy=a._penY+this._turn*this._b*h(a._penA);this._angSpeed=a._lnrSpeed*r/J(this._a,this._b);switch(this._turn){case LT:this._ccw=!0;this._sa=u;this._ea=this._sa-this._ext;break;case RT:this._ccw=!1;this._sa=r-u;this._ea=this._sa+this._ext;break;default:console.log("ERROR illegal turn")}this._deltaAngle=this._ext/this._steps;this._era=a._penA;this._ca=
this._sa;this._t=0;this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);let d=[];for(let g=1;g<=this._steps;g++){this._ca=this._sa+this._turn*this._deltaAngle*g;let [m,w]=K(this._cx,this._cy,this._a,this._b,this._era,this._ca);if(a._mode===LOGO){let z=m;m=w;w=z}d.push(new E(D,m,w))}d.push(new B(x(a._penA+this._turn*this._ext),C));a._injectTasks(d);this.setDONE();return b}}class Y extends t{constructor(...a){super(...a);this._a=e(a[0]);this._b=e(a[1]);this._ext=a[2];this._turn=a[3];this._lineDash=
[];this.setWAITING()}init(a){this.recordManager(a);[this._fillStyle,this._strokeStyle,this._lineWidth,this._penDown]=[a._fillColor,a._penColor,a._penSize,a._penDown];this._lineCap=Symbol.keyFor(a._penCap);[this._sx,this._sy,this._penA]=[a._penX,a._penY,a._penA];this._lineDash=[...a._penDash];this._cx=this._sx-this._turn*this._b*k(this._penA);this._cy=this._sy+this._turn*this._b*h(this._penA);this._angSpeed=a._lnrSpeed*r/J(this._a,this._b);switch(this._turn){case LT:this._ccw=!0;this._sa=u;this._ea=
this._sa-this._ext;break;case RT:this._ccw=!1;this._sa=r-u;this._ea=this._sa+this._ext;break;default:console.log("ERROR illegal turn")}this._era=a._penA;this._ca=this._sa;this._t=0;this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);var d=b*this._angSpeed/1E3;this._ca+=d*this._turn;var g=this._sa;this._t=(this._ca-g)/(this._ea-g);1<=this._t||!a._animate?(b=(this._t-1)*this._ext*1E3/this._angSpeed,this._t=1,this._ca=this._ea):b-=1E3*d/this._angSpeed;d=K(this._cx,this._cy,this._a,this._b,this._era,
this._ca);a._penX=d[0];a._penY=d[1];a._penA=x(this._ca+this._era+this._turn*u);if(1<=this._t&&(this.setDONE(),a._fill_track&&a._fill_points.push(["ellipse","ellipse",this._cx,this._cy,this._a,this._b,this._era,this._sa,this._ca,this._ccw]),a._poly_track)){d=l(J(this._a,this._b)*this._ext/(20*r));g=this._ext/d;for(let m=1;m<=d;m++){let w=K(this._cx,this._cy,this._a,this._b,this._era,this._sa+m*g*this._turn);a._poly_points.push(a._m_s_XY(w[0],w[1]))}}return b}render(a,b=0,d=0){!this.isWAITING()&&this._penDown&&
(a.save(),a.translate(b/2,d/2),a.fillStyle=this._fillStyle,a.strokeStyle=this._strokeStyle,a.lineWidth=this._lineWidth,a.lineCap=this._lineCap,a.setLineDash(this._lineDash),a.beginPath(),a.ellipse(this._cx,this._cy,this._a,this._b,this._era,this._sa,this._ca,this._ccw),a.stroke(),a.closePath(),a.restore())}}class W extends t{constructor(...a){super(...a);this._rad=a[0];this._fcol=a[1];this._sw=a[2];this._scol=a[3]}perform(a,b){this.recordManager(a);[this._sx,this._sy,this._penDown]=[a._penX,a._penY,
a._penDown];this._fcol="current"==this._fcol?a._fillColor:this._fcol;this._scol="current"==this._scol?a._penColor:this._scol;this._sw=0<this._sw?Number(this._sw):0==this._sw?a._penSize:0;this._rad=0>=this._rad?q(2*a._penSize,a._penSize+4):this._rad}render(a,b=0,d=0){!this.isWAITING()&&this._penDown&&(a.save(),a.translate(b/2,d/2),0<this._sw&&(a.strokeStyle=this._scol,a.lineWidth=this._sw),a.fillStyle=this._fcol,a.beginPath(),a.ellipse(this._sx,this._sy,this._rad,this._rad,0,0,r,!0),a.fill(),0<this._sw&&
a.stroke(),a.closePath(),a.restore())}}class X extends t{constructor(...a){super(...a);this._size=a[0];this._fcol=a[1];this._sw=a[2];this._scol=a[3]}perform(a,b){this.recordManager(a);[this._sx,this._sy,this._penDown]=[a._penX,a._penY,a._penDown];this._angle=a._penA;this._fcol="current"==this._fcol?a._fillColor:this._fcol;this._scol="current"==this._scol?a._penColor:this._scol;this._sw=0<this._sw?Number(this._sw):0==this._sw?a._penSize:0;this._xp=-this._size*h(f/6);this._yp=this._size*k(f/6)}render(a,
b=0,d=0){!this.isWAITING()&&this._penDown&&(a.save(),a.translate(b/2,d/2),a.translate(this._sx,this._sy),a.rotate(this._angle),a.fillStyle=this._fcol,0<this._sw&&(a.strokeStyle=this._scol,a.lineWidth=this._sw),a.beginPath(),a.moveTo(0,0),a.lineTo(this._xp,this._yp),a.lineTo(this._xp,-this._yp),a.lineTo(0,0),a.fill(),0<this._sw&&a.stroke(),a.closePath(),a.restore())}}class ba extends t{constructor(...a){super(...a);this._text=a[0];this._move=a[1];this._align=a[2];this._font=a[3];this.setWAITING()}init(a){this.recordManager(a);
[this._sx,this._sy,this._fillColor,this._mode,this._penDown]=[a._penX,a._penY,a._fillColor,a._mode,a._penDown];this._align="center"===this._align||"right"===this._align?this._align:"left";this._font=this._font??a._font;this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);this._move&&"right"!==this._align&&(a._bdc.font=this._font,b=a._bdc.measureText(this._text).width,"center"===this._align&&(b/=2),b=this._mode===LOGO?new E(this._sy+b,this._sx):new E(this._sx+b,this._sy),a._injectTasks([b]));
this.setDONE()}render(a,b=0,d=0){if(!this.isWAITING()&&this._penDown){a.save();a.translate(this._sx+b/2,this._sy+d/2);a.font=this._font;a.textAlign=this._align;a.textBaseline="bottom";a.fillStyle=this._fillColor;switch(this._mode){case LOGO:a.rotate(u);break;case STANDARD:a.scale(1,-1)}a.fillText(this._text,0,0);a.restore()}}}class O extends t{constructor(...a){super(...a);this._action=a[0]}perform(a,b){this.recordManager(a);switch(this._action){case M:var d=[a._penDown,a._penSize,[...a._penDash],
a._penCap,a._penColor,a._fillColor,a._animate,a._csrVisible,a._tilt];a._sS.push(d);break;case N:0<a.nbrStyles&&(d=a._sS.pop(),[a._penDown,a._penSize,a._penDash,a._penCap,a._penColor,a._fillColor,a._animate,a._csrVisible,a._tilt]=d)}return b}}class ea extends t{constructor(...a){super(...a)}perform(a,b){a._record=[];a._recording=!0;return b}}class fa extends t{constructor(...a){super(...a);this._id=String(a[0])}perform(a,b){0<this._id.length&&!A.hasRecord(this._id)&&A.setRecord(this._id,a._record);
a._recording=!1;a._record=[];return b}}class ia extends t{constructor(...a){super(...a);this._id=a[0]}perform(a,b){let d=A.getRecord(this._id);d&&a._injectTasks(d);return b}}class ca extends t{constructor(...a){super(...a)}perform(a,b){this.recordManager(a);a._poly_track=!0;a._poly_points=[];a._poly_points.push(a._m_s_XY(a._penX,a._penY));return b}}class da extends t{constructor(...a){super(...a);this._id=a[0]}perform(a,b){this.recordManager(a);"string"===typeof this._id&&0<this._id.length&&(a._polygons.set(this._id,
a._poly_points),a._poly_track=!1,a._poly_points=[]);this.setDONE();return b}}class P extends t{constructor(...a){super(...a)}perform(a,b){this.recordManager(a);a._fill_track=!0;a._fill_points=[];a._fill_points.push(["moveTo","moveTo",a._penX,a._penY]);return b}}class Q extends t{constructor(...a){super(...a);this._close=a[0];this._pts=[];this.setWAITING()}init(a){this.recordManager(a);[this._fillStyle,this._strokeStyle,this._lineWidth,this._penDown]=[a._fillColor,a._penColor,a._penSize,a._penDown];
[this._lineDash,this._lineCap]=[a._penDash,Symbol.keyFor(a._penCap)];this._pts=a._fill_points;this._close&&0<this._pts.length&&this._pts.push(["lineTo",a._penDown?"lineTo":"moveTo",this._pts[0][2],this._pts[0][3]]);this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);a._fill_track=!1;a._fill_points=[];this.setDONE();return b}render(a,b=0,d=0){if(!this.isWAITING()){a.save();a.translate(b/2,d/2);a.fillStyle=this._fillStyle;a.strokeStyle=this._strokeStyle;a.lineWidth=this._lineWidth;a.lineCap=
this._lineCap;b=[...this._pts];for(a.beginPath();0<b.length;)d=b.shift(),a[d[0]](...d.slice(2));a.fill();if(this._penDown){b=[...this._pts];a.beginPath();for(a.setLineDash(this._lineDash);0<b.length;)d=b.shift(),a[d[1]](...d.slice(2));a.stroke()}a.restore()}}}class V extends t{constructor(...a){super(...a);this.setWAITING()}init(a){[this._sx,this._sy]=[a._penX,a._penY];this._angle=n(-this._sy,-this._sx);this._angle=x(this._angle);this._dist=Math.sqrt((0-this._sx)**2+(0-this._sy)**2);this.setREADY()}perform(a,
b){this.isWAITING()&&this.init(a);let d=[new B(this._angle,C),new H(this._dist,1),new B(0,C)];a._injectTasks(d);this.setDONE();return b}}class E extends t{constructor(...a){super(...a);this._mt=a[0];this._x=a[1];this._y=a[2];this.setWAITING()}init(a){let [b,d]=[a._penX,a._penY],[g,m]=a._mode==LOGO?[this._y,this._x]:[this._x,this._y];g+=this._mt*a._penX;m+=this._mt*a._penY;this._angle=x(n(m-d,g-b));this._dist=Math.sqrt((g-b)**2+(m-d)**2);this.setREADY()}perform(a,b){this.isWAITING()&&this.init(a);
let d=[new B(this._angle,C),new H(this._dist,1)];a._injectTasks(d);this.setDONE();return b}}class G extends t{constructor(...a){super(...a);this._mt=a[0];this._x=a[1];this._y=a[2];this._fill_gap=a[3]}perform(a,b){let [d,g]=a._mode==LOGO?[this._y,this._x]:[this._x,this._y];d=isNaN(d)?a._penX:d;g=isNaN(g)?a._penY:g;d+=this._mt*a._penX;g+=this._mt*a._penY;let m=[];a.isFilling&&!this._fill_gap?m.push(new Q,new v("_penX",d),new v("_penY",g),new P):(m.push(new v("_penX",d),new v("_penY",g)),a._fill_track&&
a._fill_points.push(["lineTo","moveTo",d,g]),a._poly_track&&a._poly_points.push(a._m_s_XY(d,g)));a._injectTasks(m);return b}}class v extends t{constructor(...a){super(...a);this._attr=a[0];this._value=a[1]}perform(a,b){this.recordManager(a);a[`${this._attr}`]=this._value;return b}}class ja extends t{constructor(...a){super(...a)}perform(a,b){this.recordManager(a);a._clear();return b}}class ka extends t{constructor(...a){super(...a)}perform(a,b){this.recordManager(a);a._reset();return b}}class la extends t{constructor(...a){super(...a);
this._id=a[0]}perform(a,b){this.recordManager(a);if("string"===typeof this._id&&0<this._id.length){let d=a._b,g=d.width,m=d.height,w=g/2,z=m/2,R=new OffscreenCanvas(d.width,d.height),I=R.getContext("2d");I.translate(d.width/2,d.height/2);switch(a._mode){case LOGO:I.rotate(-u);break;case STANDARD:I.scale(1,-1)}I.drawImage(d,0,0,g,m,-w,-z,g,m);a._snapshots.set(this._id,R)}this.setDONE();return b}}class aa extends t{constructor(...a){super(...a);this._sleepTimeLeft=a[0];this.setREADY()}perform(a,b){this.recordManager(a);
a._animate?b>=this._sleepTimeLeft?(b-=this._sleepTimeLeft,this.setDONE()):(this._sleepTimeLeft-=b,b=0):this.setDONE();return b}}class ha extends t{constructor(...a){super(...a);this._function=a[0];this._data=a.slice(1)}perform(a,b){this.recordManager(a);this._function(a,...this._data);return b}}return[A]}();
function getImageFromOsc(e,n=p5.instance){let l=e.getContext("2d").getImageData(0,0,e.width,e.height).data,h=new Uint32Array(l);e=n.createImage(e.width,e.height);e.loadPixels();e.pixels.forEach((q,p,k)=>k[p]=h[p]);e.updatePixels();return e}function getCursorFromImage(e,n=0,l=0){e.loadPixels();var h=e.width;let q=e.height;e=new ImageData(new Uint8ClampedArray(e.pixels),h,q);h=new OffscreenCanvas(h,q);h.getContext("2d").putImageData(e,0,0);return new Cursor(h,n,l)}
