...
J=(a,b,d,g,m,w)=>{d*=h(w);g*=k(w);w=Math.sin(m);m=Math.cos(m);return[a+d*m-g*w,b+g*m+d*w]},[S,T,C]=[1,-1,0],[D,L]=[0,1],[M,N]=[1,-1],U=3*f,E=new Map;class A{static clearRecords(){E.clear()}static setRecord(a,b){E.set(a,b)}static hasRecord(a){return E.has(a)}static getRecord(a){if(A.hasRecord(a))return E.get(a).map(b=>b.clone())}static getTurtle(a,b,d){return new A(a,b,d)}constructor(a,b,d=DISPLAY,g=!0){this._b=new OffscreenCanvas(a,b);this._bdc=this._b.getContext("2d");this._interval=25;this._polygons=
