...
b,d);return v}x(a,b=!1){return this._addTask(new F(D,a,NaN,b))}y(a,b=!1){return this._addTask(new F(D,NaN,a,b))}xy(a,b,d=!1){return this._addTask(new F(D,a,b,d))}dxy(a,b,d=!1){return this._addTask(new F(K,a,b,d))}face(a){return this._addTask(new w("_penA",this._fix(a)))}fd(a){return this._addTask(new G(a,Q))}forward(a){return this.fd(a)}bk(a){return this._addTask(new G(a,R))}backward(a){return this.bk(a)}back(a){return this.bk(a)}lt(a){return this._addTask(new B(this._fix(a),LT))}left(a){return this.lt(a)}rt(a){return this._addTask(new B(this._fix(a),
RT))}right(a){return this.rt(a)}head(a){return this._addTask(new B(this._fix(a),C))}heading(a){return this.head(a)}home(){return this._addTask(new T)}goto(a,b){return this._addTask(new J(D,a,b))}goby(a,b){return this._addTask(new J(K,a,b))}dot(a=6,b="current",d=.5,g="current"){return this._addTask(new U(a,b,d,g))}arrow(a=6,b="current",d=.5,g="current"){return this._addTask(new V(a,b,d,g))}circle(a,b=0,d=RT,g=0){return this.oval(a,a,b,d,g)}oval(a,b,d=0,g=RT,m=0){d=e(0===d?r:this._degrees?d*f/180:d);
return 0===m?this._addTask(new W(a,b,d,g)):this._addTask(new X(a,b,d,g,l(m)))}sleep(a){return this._addTask(new Y(a))}write(a,b="left",d=!1,g){return this._addTask(new Z(a,b,d,g))}font(a){return this._addTask(new w("_font",a))}up(){return this._addTask(new w("_penDown",!1))}pu(){return this.up()}penup(){return this.up()}down(){return this._addTask(new w("_penDown",!0))}pd(){return this.down()}pendown(){return this.down()}pensize(a=2){return this._addTask(new w("_penSize",a))}dash(a=[]){this._addTask(new w("_penDash",
